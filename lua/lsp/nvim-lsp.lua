-- Configures the LUA language server with type definitions for the 'vim.*' globals.
-- This uses the folke/neodev plugin, and MUST be set up before the LSP plugin is
-- initialized.
